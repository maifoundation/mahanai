...
_ROUTES: dict[str, tuple[str, str]] = {
    ...
    "gpt-5.6-sol-indirect":        ("codex_direct",  "gpt-5.6-sol"),
    "gpt-5.6-terra-indirect":      ("codex_direct",  "gpt-5.6-terra"),
    "gpt-5.6-luna-indirect":       ("codex_direct",  "gpt-5.6-luna"),
    "gpt-5.5-indirect":            ("codex_direct",  "gpt-5.5"),
...
_MODEL_DISPLAY = {
    ...
    "gpt-5.6-sol-indirect":        ("GPT-5.6 Sol Indirect",    "OpenAI Codex"),
    "gpt-5.6-terra-indirect":      ("GPT-5.6 Terra Indirect",  "OpenAI Codex"),
    "gpt-5.6-luna-indirect":       ("GPT-5.6 Luna Indirect",   "OpenAI Codex"),
    "gpt-5.5-indirect":            ("GPT-5.5 Indirect",        "OpenAI Codex"),
